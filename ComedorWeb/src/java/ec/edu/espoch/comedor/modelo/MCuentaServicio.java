...
import ec.edu.espoch.comedor.entidad.CCuentaServicio;
...
public class MCuentaServicio {
     ...
     public static boolean insertarCuentaServicio(CCuentaServicio cuservicio) throws Exception {
...
public static boolean modificarCuentaServicio(CCuentaServicio cuentaser) throws Exception {
        boolean respuesta = false;
        try {
    ...
    public static ArrayList<CCuentaServicio> obtenerCuentaServicio() throws Exception {
        ArrayList<CCuentaServicio> lst = new ArrayList<CCuentaServicio>();
        try {
